---
name: code-standards
description: Use when reviewing or writing code for style/standards compliance — naming conventions, method length (≤30 lines), parameter limits (≤3), nesting depth (≤2), switch/case avoidance, verb-prefixed methods, and file naming rules. Applies to Java backend (Spring Boot) and Angular frontend (TypeScript).
---
