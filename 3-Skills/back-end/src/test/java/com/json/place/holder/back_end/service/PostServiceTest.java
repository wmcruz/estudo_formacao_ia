...
class PostServiceTest {
    ...
    @Test
    void fetchPostsPaginated_shouldReturnEmptyPage_whenPageOutOfBounds() {
        PostDto[] allPosts = {
            new PostDto(1L, 1L, "Title 1", "Body 1")
        };
        when(restTemplate.getForObject("https://jsonplaceholder.typicode.com/posts/", PostDto[].class))
        ...
        PageDto<PostDto> result = postService.fetchPostsPaginated(5, 10);
