...
Skills em `.agents/skills/` — carregadas automaticamente pela IA quando a tarefa corresponder à descrição:

| Skill | Arquivo | Quando usar |
|-------|---------|-------------|
| Angular | [angular](.agents/skills/angular/SKILL.md) | Ao trabalhar com componentes, templates, pipes e serviços Angular |
| Code standards | [code-standards](.agents/skills/code-standards/SKILL.md) | Ao revisar ou escrever código seguindo padrões do projeto |
| Tests | [tests](.agents/skills/tests/SKILL.md) | Ao implementar testes no backend ou frontend |
