...
Every feature, bug fix, or behavior change in this project **must** include automated unit tests. Contributors must write tests to ensure correctness before considering any work complete.

See also: [code-standards.md](./code-standards.md), [folder-structure.md](./folder-structure.md), and [angular.md](./angular.md).

---

## 1. Required test coverage

We write unit tests for both the backend (Java + JUnit 5 + Mockito) and frontend (Angular + Jasmine + Karma).
...
- **Java**: Stub HTTP external services with tools like Mockito mocks or Spring's `MockRestServiceServer`.
